...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport() throws Exception {
		...
		try {
			...
			writer.write("<title>Indigo - Automation Execution Results Summary</title> on "+TestEngine.browser);
			...
			writer.write("Indigo -  Automation Execution Result Summary on "+TestEngine.browser);
			writer.write("</th> ");
			writer.write("</tr> ");
	...
	public static void createHtmlSummaryReport(String browser, String Url) throws Exception {
		...
		try {
			...
			writer.write("<head> ");
			writer.write("<meta charset='UTF-8'> ");
			writer.write("<title>Indigo - Automation Execution Results Summary on "+TestEngine.browser+ "</title>");
			...
			writer.write("<tr class='heading'> ");
			writer.write("<th colspan='4' style='font-family:Copperplate Gothic Bold; font-size:1.4em;'> ");
			writer.write("Indigo -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
			writer.write("<tr class='subheading'> ");
			writer.write("<th>&nbsp;Date&nbsp;&&nbsp;Time&nbsp;:&nbsp;" + ""
