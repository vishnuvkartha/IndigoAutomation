...
public class TC_019_VerifyAimsUploaderBySelectingIVRSMSOption extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Web_Home");
	
	@Test(dataProvider = "testData")
	public void TC_019_VerifyAimsUploaderBySelectingIVRSMSOption(String Username,String Password,String Mainmenu,String Submenu,String From,String To,String Origin,
		...
		//	SelectAffectedStation(station);
			ClickSendButton();
			VerifyConfirmation();
			Reporter.SuccessReport("TC_019", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC_019,Exception message is "+e.getStackTrace().toString()+e.getMessage(), "Failed");
			e.printStackTrace();
		}
	}
